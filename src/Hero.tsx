    ...
    <section className="hero-section-wrap relative w-full min-h-[85vh] flex items-center justify-center overflow-hidden py-12 md:py-20">
      ...
      <div className="container mx-auto px-4 md:px-8 relative z-10 grid grid-cols-1 lg:grid-cols-12 gap-8 items-center max-w-7xl">
        ...
        <div className="lg:col-span-7 text-left space-y-6 md:pr-8">
          <span className="inline-flex items-center gap-2 px-3 py-1 rounded-full text-xs font-semibold bg-zinc-800/80 border border-zinc-700/50 text-zinc-300 backdrop-blur-md shadow-sm">
            <span className="w-2 h-2 rounded-full bg-emerald-500 animate-pulse"></span>
            THE 2026 EDITION &middot; 6 PORTALS &middot; 60 CAREERS
          </span>

          <h1 className="text-4xl md:text-6xl font-black tracking-tight text-white leading-tight font-sans">
          ...
          <div className="flex flex-wrap gap-4 pt-2">
            ...
            <a
              ...
              className="px-6 py-3 rounded-xl bg-zinc-900/80 hover:bg-zinc-800/80 text-zinc-300 font-medium border border-zinc-800 hover:border-zinc-700 transition-all duration-300 backdrop-blur-md"
            >
              View Leaderboard 🏆
            </a>
          </div>
